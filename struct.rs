...
fn main(){
    ...
    let user2 = retstruct(String::from("Linus"), String::from("Torvalds"), String::from("28/12/1969"), true);
    println!("User2 is the greatest {} {} born {}", user2.name, user2.surname, user2.birth);
    let ret1 = Rectangle{
        width: 43.2,
        height: 20.2
    };
